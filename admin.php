        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
  <a href="./forms/customer_register.php" class="nav-link">
...
<li class="nav-item">
  <a href="./forms/products.php" class="nav-link">
...
<li class="nav-item">
  <a href="./forms/order.php" class="nav-link">
...
<li class="nav-item">
  <a href="./forms/deliveries.php" class="nav-link">
...
<li class="nav-item">
  <a href="./forms/stocks.php" class="nav-link">
